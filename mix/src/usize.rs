fn main() {
    ...
    // println!("| f32:   min:{:>41.0} | max:{:>41.0} |", f32::MIN,     f32::MAX  );
    println!("| u32:   min:{:>41} | max:{:>41} |", u32::MIN,     u32::MAX  );
    println!("| i64:   min:{:>41} | max:{:>41} |", i64::MIN,     i64::MAX  );
    // println!("| f64:   min:{:>41.0} | max:{:>41.0} |", f64::MIN,     f64::MAX  );
    ...
    // println!("| f32:   mid:{:>41.0} | sqrt:{:>36.3} |", f32::MAX   / 2.0, (f32::MAX   as f64).sqrt());
    ...
    // println!("| f64:   mid:{:>41.0} | sqrt:{:>36.3} |", f64::MAX   / 2.0, (f64::MAX         ).sqrt());
